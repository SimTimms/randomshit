...
export default function Model({ props }) {
  const group = useRef();
  const { nodes } = useGLTF('spacemarine/bg/shoulderLeft/scene.gltf');
                  ...
                  >
                    ...
                    >
                      <Mesh
                        ...
                        modelColors={props.modelColors}
                        modelColorsRef={props.modelColorsRef}
                        name="L_SHOULDER_PAD_BLANK003"
                        lightOne={props.lightOne}
                        geometry={nodes.L_SHOULDER_PAD_BLANK003.geometry}
                      />
                      <Mesh
                        activeColor={props.activeColor.color}
                        paintMode={props.paintMode}
                        modelColors={props.modelColors}
                        modelColorsRef={props.modelColorsRef}
                        name="L_SHOULDER_PAD_BLANK003_1"
                        lightOne={props.lightOne}
                        geometry={nodes.L_SHOULDER_PAD_BLANK003_1.geometry}
                      />
                    </group>
                  </group>
                </group>
...
useGLTF.preload('spacemarine/bg/shoulderLeft/scene.gltf');
